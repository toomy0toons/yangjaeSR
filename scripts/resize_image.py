...
def main():
    ...
    # #TEST
    # # HR images
    # opt['input_folder'] = '/workspace/dacon/yangjaeSR-mod/test/hr'
    # opt['save_folder'] = '/workspace/dacon/yangjaeSR-cropped/test/hr'
    # opt['crop_size'] = 480
    # opt['step'] = 240
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
    ...
    # # LR images
    # opt['input_folder'] = '/workspace/dacon/yangjaeSR-mod/test/lr'
    # opt['save_folder'] = '/workspace/dacon/yangjaeSR-cropped/test/lr'
    # opt['crop_size'] = 120
    # opt['step'] = 60
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
...
def extract_subimages(opt):
    ...
    img_list = list(scandir(input_folder, full_path=True, suffix=('.png', '.jpg', '.bmp','jpeg','JPG','JPEG')))
...
def worker(path, opt):
    ...
    #resize GT
    #img = imutils.resize(img, width=2048, height=2048)
    #generate LQS
    h, w = img.shape[0:2]
    ...
    for x in h_space:
        for y in w_space:
            ...
            cv2.imwrite(
                osp.join(opt['save_folder'], f'{img_name}_{index}.png'), cropped_img,
